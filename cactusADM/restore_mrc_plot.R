...
legend(162144,0.04,legend=c("original","10","25","40","50","60","dropped","90"), 
...
legend(162144,0.04,legend=c("original","D10","restored"), 
...
points(DATA2,col=3,lty=3, pch='.')
legend(162144,0.04,legend=c("original","D25","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
legend(162144,0.04,legend=c("original","D40","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
legend(162144,0.04,legend=c("original","D50","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
legend(162144,0.04,legend=c("original","D60","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
points(DATA6,col=3,lty=3, pch='.')
legend(162144,0.04,legend=c("original","Drop","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
...
legend(162144,0.04,legend=c("original","D90","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
