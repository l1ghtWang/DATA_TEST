...
plot(data,main = benchmark,col=1,ylim = c(0,0.015),xlim = c(0,2e+05),lty=1, pch='.')
...
plot(data,main =  paste(benchmark ,"_D10_restore_v2",sep=""),col=1,ylim = c(0,0.015),xlim = c(0,2e+05),lty=1, pch='.')
...
plot(data,main =  paste(benchmark ,"_D25_restore_v2",sep=""),col=1,ylim = c(0,0.015),xlim = c(0,2e+05),lty=1, pch='.')
points(data2,col=2,lty=3, pch='.')
points(DATA2,col=3,lty=3, pch='.')
legend(150000,0.005,legend=c("original","D25","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
 
plot(data,main =  paste(benchmark ,"_D40_restore_v2",sep=""),col=1,ylim = c(0,0.015),xlim = c(0,2e+05),lty=1, pch='.')
points(data3,col=2,lty=3, pch='.')
points(DATA3,col=3,lty=3, pch='.')
legend(150000,0.005,legend=c("original","D40","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
 
plot(data,main =  paste(benchmark ,"_D50_restore_v2",sep=""),col=1,ylim = c(0,0.015),xlim = c(0,2e+05),lty=1, pch='.')
points(data4,col=2,lty=3, pch='.')
points(DATA4,col=3,lty=3, pch='.')
legend(150000,0.005,legend=c("original","D50","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
 
plot(data,main =  paste(benchmark ,"_D60_restore_v2",sep=""),col=1,ylim = c(0,0.015),xlim = c(0,2e+05),lty=1, pch='.')
points(data5,col=2,lty=3, pch='.')
points(DATA6,col=3,lty=3, pch='.')
legend(150000,0.005,legend=c("original","D60","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
 
plot(data,main =  paste(benchmark ,"_drop_restore_v2",sep=""),col=1,ylim = c(0,0.015),xlim = c(0,2e+05),lty=1, pch='.')
points(data6,col=2,lty=3, pch='.')
points(DATA6,col=3,lty=3, pch='.')
legend(150000,0.005,legend=c("original","Drop","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
 
plot(data,main =  paste(benchmark ,"_D90_restore_v2",sep=""),col=1,ylim = c(0,0.015),xlim = c(0,2e+05),lty=1, pch='.')
