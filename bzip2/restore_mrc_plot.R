...
data1 = read.csv("AET_PIN_DROP_10_bzip2_JAN21.out")
data2 = read.csv("AET_PIN_DROP_25_bzip2_AUG25.out")
data3 = read.csv("AET_PIN_DROP_40_bzip2_JAN21.out")
data4 = read.csv("AET_PIN_DROP_50_bzip2_AUG25.out")
data5 = read.csv("AET_PIN_DROP_60_bzip2_JAN21.out")
data6 = read.csv("AET_PIN_DROP_bzip2_AUG25.out")
data7 = read.csv("AET_PIN_DROP_90_bzip2_JAN21.out")
