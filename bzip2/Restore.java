...
{ 
  ...
  File file = new File("AET_PIN_bzip2_AUG25.out"); 
  File file2 = new File("AET_PIN_DROP_10_bzip2_JAN21.out");
  File file3 = new File("AET_PIN_DROP_25_bzip2_AUG25.out");
  File file4 = new File("AET_PIN_DROP_40_bzip2_JAN21.out");
  File file5 = new File("AET_PIN_DROP_50_bzip2_AUG25.out");
  File file6 = new File("AET_PIN_DROP_60_bzip2_JAN21.out");
  File file7 = new File("AET_PIN_DROP_bzip2_AUG25.out");
  File file8 = new File("AET_PIN_DROP_90_bzip2_JAN21.out");
