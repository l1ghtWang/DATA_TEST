...
{ 
  ...
  File file = new File("AET_PIN_gamess_SEP12.out"); 
  File file2 = new File("AET_PIN_DROP_10_gamess_JAN21.out");
  File file3 = new File("AET_PIN_DROP_25_gamess_SEP12.out");
  File file4 = new File("AET_PIN_DROP_40_gamess_JAN21.out");
  File file5 = new File("AET_PIN_DROP_50_gamess_SEP12.out");
  File file6 = new File("AET_PIN_DROP_60_gamess_JAN21.out");
  File file7 = new File("AET_PIN_DROP_gamess_SEP12.out");
  File file8 = new File("AET_PIN_DROP_90_gamess_JAN21.out");
