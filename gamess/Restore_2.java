...
{ 
  ...
  FileWriter fileWriter2 = new FileWriter(benchmark+"_"+Integer.toString(section)+"section_restored_v2_10.out",false);
  FileWriter fileWriter3 = new FileWriter(benchmark+"_"+Integer.toString(section)+"section_restored_v2_25.out",false);
  FileWriter fileWriter4 = new FileWriter(benchmark+"_"+Integer.toString(section)+"section_restored_v2_40.out",false);
  FileWriter fileWriter5 = new FileWriter(benchmark+"_"+Integer.toString(section)+"section_restored_v2_50.out",false);
  FileWriter fileWriter6 = new FileWriter(benchmark+"_"+Integer.toString(section)+"section_restored_v2_60.out",false);
  FileWriter fileWriter7 = new FileWriter(benchmark+"_"+Integer.toString(section)+"section_restored_v2_drop.out",false);
  FileWriter fileWriter8 = new FileWriter(benchmark+"_"+Integer.toString(section)+"section_restored_v2_90.out",false);
  FileWriter fileWriter9 = new FileWriter(benchmark+"_"+Integer.toString(section)+"section_error_report_v2.txt",false);
...
*/
   ...
   //System.out.println(length+"  "+(length/5)); 
	...
	int len_out_data2 = Restore_2.restoreData( data2, out_data2, data1, length, section);
	int len_out_data3 = Restore_2.restoreData( data3, out_data3, data1, length, section);
	int len_out_data4 = Restore_2.restoreData( data4, out_data4, data1, length, section);
	int len_out_data5 = Restore_2.restoreData( data5, out_data5, data1, length, section);
	int len_out_data6 = Restore_2.restoreData( data6, out_data6, data1, length, section);
	int len_out_data7 = Restore_2.restoreData( data7, out_data7, data1, length, section);
	int len_out_data8 = Restore_2.restoreData( data8, out_data8, data1, length, section);
