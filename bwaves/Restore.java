...
{ 
  ...
  File file = new File("AET_PIN_bwaves_SEP6.out"); 
  File file2 = new File("AET_PIN_DROP_10_bwaves_JAN21.out");
  File file3 = new File("AET_PIN_DROP_25_bwaves_SEP6.out");
  File file4 = new File("AET_PIN_DROP_40_bwaves_JAN21.out");
  File file5 = new File("AET_PIN_DROP_50_bwaves_SEP6.out");
  File file6 = new File("AET_PIN_DROP_60_bwaves_JAN21.out");
  File file7 = new File("AET_PIN_DROP_bwaves_SEP6.out");
  File file8 = new File("AET_PIN_DROP_90_bwaves_JAN21.out");

  String st;
  int i = 0;
  int cut =15000000/256; 
  int section = 5;
  if(args.length == 1) section = Integer.valueOf(args[0]);
  String benchmark = "bwaves";
