...
data1 = pd.read_csv('AET_PIN_HIST_SP_DROP_25_'+my_benchmark+'.out', sep=',',header='infer',nrows=my_nrows)
data2 = pd.read_csv('AET_PIN_HIST_SP_DROP_50_'+my_benchmark+'.out', sep=',',header='infer',nrows=my_nrows)
data3 = pd.read_csv('AET_PIN_HIST_SP_DROP_'+my_benchmark+'.out', sep=',',header='infer',nrows=my_nrows)
