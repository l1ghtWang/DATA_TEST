...
data1 = read.csv("AET_PIN_DROP_10_bwaves_JAN21.out")
data2 = read.csv("AET_PIN_DROP_25_bwaves_SEP6.out")
data3 = read.csv("AET_PIN_DROP_40_bwaves_JAN21.out")
data4 = read.csv("AET_PIN_DROP_50_bwaves_SEP6.out")
data5 = read.csv("AET_PIN_DROP_60_bwaves_JAN21.out")
data6 = read.csv("AET_PIN_DROP_bwaves_SEP6.out")
data7 = read.csv("AET_PIN_DROP_90_bwaves_JAN21.out")
...
plot(data,main = benchmark,col=1,ylim = c(0,0.17),lty=1, pch='.')
...
legend(1e+07,0.10,legend=c("original","10","25","40","50","60","dropped","90"), 
       col=c(1,2,3,4,5,6,7,8), pch=c(16,16,16,16,16,16,16,16), ncol=1)
dev.off()

pdf(file=paste(benchmark,"_",section,"section_D10_restore.pdf",sep=""))
plot(data,main = paste(benchmark,"_",section,"section_D10_restore",sep = ""),col=1,ylim = c(0,0.17),lty=1, pch='.')
points(data1,col=2,lty=3, pch='.')
points(DATA1,col=3,lty=3, pch='.')
legend(1e+07,0.10,legend=c("original","D10","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()

pdf(file=paste(benchmark,"_",section,"section_D25_restore.pdf",sep=""))
plot(data,main = paste(benchmark,"_",section,"section_D25_restore",sep = ""),col=1,ylim = c(0,0.17),lty=1, pch='.')
points(data2,col=2,lty=3, pch='.')
points(DATA2,col=3,lty=3, pch='.')
legend(1e+07,0.10,legend=c("original","D25","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()

pdf(file=paste(benchmark,"_",section,"section_D40_restore.pdf",sep=""))
plot(data,main = paste(benchmark,"_",section,"section_D40_restore",sep = ""),col=1,ylim = c(0,0.17),lty=1, pch='.')
points(data3,col=2,lty=3, pch='.')
points(DATA3,col=3,lty=3, pch='.')
legend(1e+07,0.10,legend=c("original","D40","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()

pdf(file=paste(benchmark,"_",section,"section_D50_restore.pdf",sep=""))
plot(data,main = paste(benchmark,"_",section,"section_D50_restore",sep = ""),col=1,ylim = c(0,0.17),lty=1, pch='.')
points(data4,col=2,lty=3, pch='.')
points(DATA4,col=3,lty=3, pch='.')
legend(1e+07,0.10,legend=c("original","D50","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()

pdf(file=paste(benchmark,"_",section,"section_D60_restore.pdf",sep=""))
plot(data,main = paste(benchmark,"_",section,"section_D60_restore",sep = ""),col=1,ylim = c(0,0.17),lty=1, pch='.')
points(data5,col=2,lty=3, pch='.')
points(DATA6,col=3,lty=3, pch='.')
legend(1e+07,0.10,legend=c("original","D60","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()

pdf(file=paste(benchmark,"_",section,"section_Drop_restore.pdf",sep=""))
plot(data,main = paste(benchmark,"_",section,"section_drop_restore",sep = ""),col=1,ylim = c(0,0.17),lty=1, pch='.')
points(data6,col=2,lty=3, pch='.')
points(DATA6,col=3,lty=3, pch='.')
legend(1e+07,0.10,legend=c("original","Drop","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()

pdf(file=paste(benchmark,"_",section,"section_D90_restore.pdf",sep=""))
plot(data,main = paste(benchmark,"_",section,"section_D90_restore",sep = ""),col=1,ylim = c(0,0.17),lty=1, pch='.')
points(data7,col=2,lty=3, pch='.')
points(DATA7,col=3,lty=3, pch='.')
legend(1e+07,0.10,legend=c("original","D90","restored"), 
       col=c(1,2,3), pch=c(16,16,16), ncol=1)
dev.off()
